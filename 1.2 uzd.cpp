// 1.2 uzd.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
void count_median(std::vector<int> pazymiai) //funkcija, skaiciuojanti mediana
{
    int sk = 0;
